          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'} text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 ${!isSubmitting ? 'transform hover:scale-[1.02]' : ''}`}
              >
                {isSubmitting ? (
                  <>
