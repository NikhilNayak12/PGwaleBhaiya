...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 text-slate-200">
      <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-1 md:grid-cols-4 gap-8 justify-items-start">
        {/* Brand */}
        <div>
          <div className="flex items-center gap-3 mb-4">
            <img src="/image.png" alt="PG wale Bhaiya" className="w-12 h-12 rounded-md" />
            <div className="text-white font-semibold">PG wale Bhaiya</div>
          </div>
          <p className="text-base text-slate-300 leading-relaxed">
            Your trusted partner in finding the perfect accommodation near LPU. Making student life easier, one room at a time.
          </p>

          {/* Social icons */}
          <div className="mt-6 flex items-center gap-3">
            <a href="#" className="w-12 h-12 rounded-md bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-slate-700">
              <Instagram size={22} />
            </a>
            <a href="tel:+919109222131" className="w-12 h-12 rounded-md bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-slate-700">
              <Phone size={22} />
            </a>
            <a href="mailto:hello.pgwalebhaiya@gmail.com" className="w-12 h-12 rounded-md bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-slate-700">
              <Mail size={22} />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="text-slate-300 text-base space-y-4">
            ...
            <li className="flex items-start gap-3">
              <span className="mt-1 text-sky-400"><Clock size={18} /></span>
              <div>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between text-slate-400 text-base">
